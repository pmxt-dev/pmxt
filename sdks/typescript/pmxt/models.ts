...
export interface UnifiedMarket {
    ...
    outcomes: MarketOutcome[] & {
        /** Convenience: first outcome (Yes / affirmative side) */
        readonly yes?: MarketOutcome;
        /** Convenience: second outcome (No / negative side) */
        readonly no?: MarketOutcome;
        /** Alias for yes */
        readonly up?: MarketOutcome;
        /** Alias for no */
        readonly down?: MarketOutcome;
    };
